...
int main() {
	...
	while (true) {
		...
		cout << "№4 - Четвертая неделя\n";
		cout << "№5 - Дополнительные задания\n";
		cout << "Ввод нуля завершит программу\n\n";

		semanaNumero = inputInt(0, 5);
		...
		case 5: do {
			khanZamai();
			system("cls");
			cout << "\n\n\n\n\n----------------Вы вышли в меню доп. заданий----------------\n\n\n\n\n" << endl;

			cout << "Для просмотра заданий введите номер задания (1-5)" << endl;
			cout << endl;
			cout << "№1 - задание \"Спиннеры\"\n";
			cout << "№2 - задание \"Сортировка слиянием\" \n";
			cout << "№3 - задание \"???\" \n";
			cout << "Ввод нуля выйдет в меню выбора недели\n";

			taskNumber = inputInt(0, 3);
			system("cls");
